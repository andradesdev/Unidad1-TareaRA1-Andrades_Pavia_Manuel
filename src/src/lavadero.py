...
class Lavadero:
    """
    Representa un túnel de lavado con:
    - Estados (fases)
    - Reglas de negocio
    - Control de ingresos
    ...
    """
    Estas constantes permiten:
    - Evitar números mágicos
    - Facilitar las pruebas unitarias
    - Seguir claramente los flujos definidos
    """
    ...
    """
    Permiten acceder a atributos privados de forma segura, esto evita modificaciones externas indebidas.
    """
    ...
    def avanzarFase(self):
        """
        Controla el autómata de estados del lavadero:
        - Decide la siguiente fase según opciones
        - Llama a terminar() cuando acaba el ciclo
        - Actualiza ingresos solo una vez
        """
